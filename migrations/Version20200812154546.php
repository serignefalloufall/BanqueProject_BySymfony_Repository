 ...
 */
final class Version20200812154546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employeur (id INT AUTO_INCREMENT NOT NULL, numidentification VARCHAR(50) DEFAULT NULL, raisonsocial VARCHAR(50) DEFAULT NULL, nomemployeur VARCHAR(60) DEFAULT NULL, adresseemployeur VARCHAR(60) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
